...
API_ID = int(environ['21381830'])
API_HASH = environ['ccfee479b3e713a64c488536cefa883e']
BOT_TOKEN = environ['6288754546:AAGyk3hcOJ-2-vT4KfdQhxrG76d8j5qxLqk']
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://admin:admin@cluster0.ckbwtcs.mongodb.net/?retryWrites=true&w=majority")
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '0').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get('REQ_CHANNEL'))

#ai
AI = is_enabled((environ.get("AI","True")), False)
OPENAI_API = environ.get("OPENAI_API","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")
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001501584675")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '5412220306').split()]
